...
#define GENERATE_KEY_KEK COMMAND(TYPE_KEY,1)
#define GENERATE_KEY_ECC COMMAND(TYPE_KEY,1)
#define GENERATE_AGREEMENT_DATA_ECC COMMAND(TYPE_KEY,1)
#define GENERATE_AGREEMENT_DATA_KEY_ECC COMMAND(TYPE_KEY,1)
...
#define EXCHANGE_DIGIT_ENVELOPE_RSA  COMMAND(TYPE_KEY,1)
#define EXCHANGE_DIGIT_ENVELOPE_ECC  COMMAND(TYPE_KEY,1)
